...
\large\textbf{Text Mining} is a \alert{general term} covering several different ideas, e.\,g.:\pause\normalsize
...
\large{Some facts about Information Extraction (IE):}\normalsize
\begin{itemize}
\item \enquote{\textit{[IE] is the task of automatically extracting structured information from unstructured [\dots] documents.}}\pause
