...
\titlegraphic{
    \tikz[overlay,remember picture]
        \node[xshift=-3em,yshift=3em,at=(current page.south east), anchor=south east] {
            \includegraphics[width=0.25\textwidth]{../archaide+acronimo-colore.eps}
        };
}
\input{config.tex}
...
\visible<4>{
\begin{figure}
\hspace*{-1.5em}\includegraphics[width=1.1\textwidth]{img/iepy.png}
