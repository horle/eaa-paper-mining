...
\tikzset{%
  ...
  lab/.style={anchor=base,text width=5em,font=\itshape\scriptsize},
  back group/.style={fill=yellow!20,rounded corners, draw=black!50, thick,dashed, inner ysep=5pt,minimum height=2cm},
  imp/.style={etape}
}
...
\node[back group, fill=orange!30] [fit=(uima) (start) (1) (2) (3)] {};
\end{pgfonlayer}
...
here rule-based approach and machine learning
\end{frame}
