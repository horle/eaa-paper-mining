...
\author[T.\ Evans \&\ F.\ Kußmaul]{{\Large Dr Tim Evans}\hfill\raisebox{-.9em}{\includegraphics[width=4cm]{img/york.jpg}}\\[1.2em]{\Large Felix Kußmaul}\hfill\raisebox{-.7em}{\includegraphics[width=4cm]{img/uco.jpg}}}
...
\institute[York, Cologne]{EAA Maastricht 2017}
...
\visible<2->{
\begin{figure}
\includegraphics[width=.9\textwidth]{img/eleph.jpg}
\end{figure}}
